...
if __name__ == '__main__':
    ...
    all_transformed_data = T.transform_data(
        data, thetas, outsize=(350, 350), output_all=True)

    # Get the corresponding numpy arrays in correct format
    transformed_data = [data.permute(
        0, 2, 3, 1) if args.backend == 'pytorch' else data]
